...
class UsuarioControllerTest {
	...
	void testAdicionaDoador() {
		// "PESSOA_FISICA", "IGREJA", "ORGAO_PUBLICO_MUNICIPAL",
		// "ORGAO_PUBLICO_ESTADUAL", "ORGAO_PUBLICO_FEDERAL", "ONG", "ASSOCIACAO",
		// "SOCIEDADE"
	...
	void testPesquisaUsuarioPorId() {
		...
		assertEquals(controller.pesquisaUsuarioPorId("84473712044"),
				"Murilo Luiz Brito/84473712044, muriloluiz@ipmmi.org.br, (31) 99770-7474, status: receptor");

		assertThrows(UnsupportedOperationException.class, () -> controller.pesquisaUsuarioPorId("10"));
		assertThrows(UnsupportedOperationException.class, () -> controller.pesquisaUsuarioPorId("-10"));
	}
	...
	void testPesquisaUsuarioPorNome() {
		...
		assertEquals(controller.pesquisaUsuarioPorNome("Murilo Luiz Brito"),
				"Murilo Luiz Brito/84473712044, muriloluiz@ipmmi.org.br, (31) 99770-7474, status: receptor");

		controller.adicionaDoador("3", "nome2", "celular", "email", "IGREJA");
		assertEquals(controller.pesquisaUsuarioPorNome("nome2"),
				"nome2/2, celular, email, status: doador | nome2/3, celular, email, status: doador");

		assertThrows(IllegalArgumentException.class, () -> controller.pesquisaUsuarioPorNome(" "));
		assertThrows(IllegalArgumentException.class, () -> controller.pesquisaUsuarioPorNome(null));
	}
	...
	void testAtualizaUsuario() {
		...
		assertEquals(controller.atualizaUsuario("1", "", "celularnovo", ""),
				"nome1/1, celularnovo, email, status: doador");
		assertEquals(controller.pesquisaUsuarioPorId("1"), "nome1/1, celularnovo, email, status: doador");

		assertEquals(controller.atualizaUsuario("1", "nomenovo", " ", ""),
				"nomenovo/1, celularnovo, email, status: doador");
		assertEquals(controller.atualizaUsuario("1", " ", " ", "emailnovo"),
				"nomenovo/1, celularnovo, emailnovo, status: doador");
		assertEquals(controller.atualizaUsuario("1", " ", " ", ""),
				"nomenovo/1, celularnovo, emailnovo, status: doador");

		assertThrows(IllegalArgumentException.class, () -> controller.atualizaUsuario("", " ", " ", ""));

		assertThrows(UnsupportedOperationException.class, () -> controller.atualizaUsuario("-1", " ", " ", ""));
	...
	void testRemoveUsuario() {
		...
		assertThrows(UnsupportedOperationException.class, () -> controller.pesquisaUsuarioPorId("1"));

		assertEquals(controller.pesquisaUsuarioPorId("84473712044"),
				"Murilo Luiz Brito/84473712044, muriloluiz@ipmmi.org.br, (31) 99770-7474, status: receptor");
		controller.removeUsuario("84473712044");

		assertThrows(UnsupportedOperationException.class, () -> controller.pesquisaUsuarioPorId("84473712044"));
	...
	void testAdicionaItemParaDoacao() {
		...
		assertThrows(NumberFormatException.class, () -> controller.adicionaItem("1", " ", "roupa", 2, "guarda,roupa"));
		assertThrows(IllegalArgumentException.class, () -> controller.adicionaItem("1", "01", " ", 2, "guarda,roupa"));
		assertThrows(IllegalArgumentException.class,
	...
	void testExibeItemParaDoacao() {
		...
		assertThrows(UnsupportedOperationException.class, () -> controller.exibeItem("1", "1"));
		assertThrows(UnsupportedOperationException.class, () -> controller.exibeItem("01", "4"));
		assertThrows(UnsupportedOperationException.class, () -> controller.exibeItem("1", " "));
		assertThrows(UnsupportedOperationException.class, () -> controller.exibeItem(" ", "1"));
	}
	...
	void testAtualizaQuantidadeItem() {
		...
		assertThrows(UnsupportedOperationException.class, () -> controller.atualizaQuantidadeItem(" ", "1", 4));
		assertThrows(UnsupportedOperationException.class, () -> controller.atualizaQuantidadeItem("01", "", 4));
		assertThrows(UnsupportedOperationException.class, () -> controller.atualizaQuantidadeItem("41", "1", 4));
		assertThrows(IllegalArgumentException.class, () -> controller.atualizaQuantidadeItem("01", "1", 0));
	}
	...
	void testRemoveItemParaDoacao() {
		...
		assertThrows(UnsupportedOperationException.class, () -> controller.removeItem("01", "1"));
		assertThrows(UnsupportedOperationException.class, () -> controller.removeItem("031", "11"));
	}
	...
	void testGetItemDescritor() {
		...
		assertThrows(UnsupportedOperationException.class, () -> controller.getItemDescritor("011", "1"));
		assertThrows(UnsupportedOperationException.class, () -> controller.getItemDescritor("01", "41"));
	...
	public void testPesquisaItemParaDoacaoPorDescricaoUpperCase() {
		...
		assertEquals("1 - fralda, tags: [geriatrica, pequena], quantidade: 10",
				this.controller.pesquisaItemParaDoacaoPorDescricao("FRALDA"));
	}
	...
	public void testPesquisaItemParaDoacaoPorDescricao() {
		...
		assertEquals(
				"2 - fralda, tags: [bebe, pequena], quantidade: 2 | 1 - fralda, tags: [geriatrica, pequena], quantidade: 10",
				this.controller.pesquisaItemParaDoacaoPorDescricao("fralda"));
	}
	...
	@Test
	public void testaInicializaSistema() {

		String itens = this.controller.listaItens("doador");

		this.controller.inicializaSistema();

		String itensPopulados = this.controller.listaItens("doador");
	...
	public void testFinalizaSistema()
	{
		...
		assertEquals(itensPopulados,this.controller.listaItens("doador"));
